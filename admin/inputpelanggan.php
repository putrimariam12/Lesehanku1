...
<li class="dropdown">
     ...
     <br><br><center><h2><b>  Silahkan input semua data Pelanggan Lesehanku dengan Benar!</b></h2></center><br>
      
      <div class="col-md-4">
 <img src="../img/restauran.jpg" class="img-circle" width="350px" height="300px"></div>
      ...
      <div class="col-md-8">
        <form action="proses-inputpelanggan.php" method="POST">
          <div class="form-group">
...
<div class="form-group">
  ...
  <input type="emiluser" name="email" class="form-control" placeholder="@gmail.com">
  </div>


  <div class="form-group">
    <label for="no_hp">NO Hp</label>
  <input type="number" name="no_hp" class="form-control" placeholder="+62 8**** ****">
  </div>

  <div class="form-group">
    <label for="alamat">alamat</label>
    <textarea name="alamat" class="form-control" placeholder="jln()"></textarea>
  </div>
...
<a href="data-pelanggan.php" class="btn btn-warning">Back</a>
