...
<li class="dropdown">
     ...
     <br><br><center><h2><b>  Silahkan input semua data Makanan Lesehanku dengan Benar!</b></h2></center><br>
 ...
 <img src="../img/15.png" class="img-circle" width="350px" height="300px"></div>
      ...
      <div class="col-md-8">
        <form action="proses-inputminuman.php" method="POST">
          <div class="form-group">
            <label for="id_minuman">Kode Minuman</label>
            <input type="number" name="id_minuman" class="form-control">
          </div>

    <div class="form-group">
    <label for="nama">nama Minuman</label>
    <input type="text" name="nama" class="form-control" placeholder="Isikan Nama Minuman valid!">

  <div class="form-group">
    <label for="jumlah">Jumlah</label>
    <input type="number" name="jumlah" class="form-control" placeholder="Isikan Jumlah Stok Minuman anda!">
  </div>
...
<div class="form-group">
    ...
    <input type="textarea" name="menu" class="form-control">
  </div>
...
<a href="data-minuman.php" class="btn btn-warning">Back</a>
