...
<div class="col-md-12 list-group-item-info">
<?php

if(@$_GET['pesan']=="inputMakananBerhasil"){
?>
...
if(@$_GET['pesan']=="hapusMakananBerhasil"){
?>
...
if(@$_GET['pesan']=="editMakananBerhasil"){
?>
...
?>
    ...
    <thead>
    <tr><center>
      <td><center><b>Kode Makanan</b></center>
      </td><td><center><b>Nama Makanan</b></center></td>
      <td><center><b>Jumlah </b></center></td>
      <td><center><b>Harga</b></center></td>
      <td><center><b>Menu</b></td>
      <th>
                <a href="inputmakanan.php">
    ...
    include"koneksi.php";
$sql=$koneksi->query("select * from dt_makanan order by id_makanan ASC");
  ...
  <tr>
      ...
      <td>
             ...
             <a href="edit-makanan.php?id=<?php echo $row['id_makanan']?>">
                 ...
                 <a href="hapusmakanan.php?id=<?php echo $row['id_makanan']?>" onclick="return confirm('anda yakin menghapus data?')">
