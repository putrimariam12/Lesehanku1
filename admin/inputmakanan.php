...
<li class="dropdown">
     ...
     <br><br><center><h2><b>  Silahkan input semua data Makanan Lesehanku dengan Benar!</b></h2></center><br>
      ...
      <div class="col-md-4">
 <img src="../img/pos1.png" class="img-circle" width="350px" height="300px"></div>
      ...
      <div class="col-md-8">
        <form action="proses-inputmakanan.php" method="POST">
          <div class="form-group">
            <label for="id_makanan">Kode Makanan</label>
            <input type="number" name="id_makanan" class="form-control">
          </div>

    <div class="form-group">
    <label for="name">nama makanan</label>
    <input type="text" name="nama" class="form-control" placeholder="Isikan Nama valid!">
...
<a href="data-makanan.php" class="btn btn-warning">Back</a>
