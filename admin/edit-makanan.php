...
<li class="dropdown">
	...
	<div class="col-md-12">
		<div class="row">
			...
			<div class="col-md-7">
				<form action="proses-editmakanan.php" method="POST">
					<?php
					include "koneksi.php";
					$id=$_GET['id'];
					$sql=$koneksi->query("SELECT * from dt_makanan where id_makanan='$id'");
...
<input type="reset" name="kirim" value="kosongkan" class="btn btn-danger">
 <a href="data-makanan.php" class="btn btn-md btn-warning">Kembali</a>
<?php
						} 
					?>
</div>
